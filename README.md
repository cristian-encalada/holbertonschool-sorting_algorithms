...
### __Data Structure and Functions__
...
Write in the file [0-O](./0-O), the big O notations of the time complexity of the Bubble sort algorithm, with 1 notation per line:
...
Write in the file [1-O](./1-O), the big O notations of the time complexity of the Insertion sort algorithm, with 1 notation per line:
...
Write in the file [2-O](./2-O), the big O notations of the time complexity of the Selection sort algorithm, with 1 notation per line:
...
Write in the file [3-O](./3-O), the big O notations of the time complexity of the Quick sort algorithm, with 1 notation per line:
...
* __Hiojam Rodríguez__ - *Holberton Student* 
    - Github: [Hiojam Rodríguez](https://github.com/Hiojam)
